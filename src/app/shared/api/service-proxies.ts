...
export class AccountServiceProxy {
     ...
     * @return OK
     */
    searchUsers(query: string | undefined, skip: number | undefined, take: number | undefined): Observable<ProfileDto[]> {
        let url_ = this.baseUrl + "/api/Account/SearchUsers?";
        if (query === null)
    ...
    protected processSearchUsers(response: HttpResponseBase): Observable<ProfileDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class GetBanStatusServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    banStatus(userId: string): Observable<BanStatusDto> {
        let url_ = this.baseUrl + "/api/Account/GetBanStatus/ban-status/{userId}";
        if (userId === undefined || userId === null)
            throw new globalThis.Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBanStatus(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBanStatus(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<BanStatusDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BanStatusDto>;
        }));
    }

    protected processBanStatus(response: HttpResponseBase): Observable<BanStatusDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BanStatusDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class ChatServiceProxy {
     ...
     * @return OK
     */
    getChats(skip: number | undefined, take: number | undefined): Observable<ChatDto[]> {
...
export class ModerationServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return No Content
     */
    banUser(body: BanRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Moderation/BanUser";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBanUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBanUser(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processBanUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    unbanUser(userId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Moderation/UnbanUser/{userId}";
        if (userId === undefined || userId === null)
            throw new globalThis.Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUnbanUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUnbanUser(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUnbanUser(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PublicationServiceProxy {
     ...
     * @return Created
     */
    create(description: string | undefined, files: FileParameter[] | undefined): Observable<Publication> {
     ...
     * @return OK
     */
    getPulicationCountByAuthor(id: string | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/Publication/GetPulicationCountByAuthor?";
        if (id === null)
            throw new globalThis.Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPulicationCountByAuthor(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPulicationCountByAuthor(response_ as any);
                } catch (e) {
    ...
    protected processGetPulicationCountByAuthor(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    /**
     * @param publicationId (optional) 
     * @param authorId (optional) 
     * @param content (optional) 
     * @param files (optional) 
     * @return Created
     */
    comment(publicationId: string | undefined, authorId: string | undefined, content: string | undefined, files: FileParameter[] | undefined): Observable<CommentDto> {
        let url_ = this.baseUrl + "/api/Publication/Comment";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = new FormData();
        if (publicationId === null || publicationId === undefined)
            throw new globalThis.Error("The parameter 'publicationId' cannot be null.");
        else
            content_.append("PublicationId", publicationId.toString());
        if (authorId === null || authorId === undefined)
            throw new globalThis.Error("The parameter 'authorId' cannot be null.");
        else
            content_.append("AuthorId", authorId.toString());
        if (content === null || content === undefined)
            throw new globalThis.Error("The parameter 'content' cannot be null.");
        else
            content_.append("Content", content.toString());
     ...
     * @return OK
     */
    get(skip: number | undefined, take: number | undefined): Observable<PublicationDto[]> {
    ...
    protected processGet(response: HttpResponseBase): Observable<PublicationDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    search(query: string | undefined, sortBy: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PublicationDto[]> {
     ...
     * @return OK
     */
    update(id: string | undefined, body: PublicationCreateRequest | undefined): Observable<PublicationDto[]> {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.publications)) {
            ...
            for (let item of this.publications)
                data["publications"].push(item ? item.toJSON() : undefined as any);
        }
...
export class BanRequest implements IBanRequest {
    userId!: string;
    reason?: string | undefined;
    bannedUntil?: string | undefined;

    constructor(data?: IBanRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.bannedUntil = _data["bannedUntil"];
        }
    }

    static fromJS(data: any): BanRequest {
        data = typeof data === 'object' ? data : {};
        let result = new BanRequest();
        result.init(data);
        return result;
    }
...
export class BanStatusDto implements IBanStatusDto {
    isBanned?: boolean;
    reason?: string | undefined;
    bannedAt?: string | undefined;
    bannedUntil?: string | undefined;
    bannedByUserId?: string | undefined;

    constructor(data?: IBanStatusDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.reason = _data["reason"];
            this.bannedAt = _data["bannedAt"];
            this.bannedUntil = _data["bannedUntil"];
            this.bannedByUserId = _data["bannedByUserId"];
        }
    }

    static fromJS(data: any): BanStatusDto {
        data = typeof data === 'object' ? data : {};
        let result = new BanStatusDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["bannedUntil"] = this.bannedUntil;
        data["bannedByUserId"] = this.bannedByUserId;
        return data;
    }
}

export interface IBanStatusDto {
    isBanned?: boolean;
    reason?: string | undefined;
    bannedAt?: string | undefined;
    bannedUntil?: string | undefined;
...
export class CloudStoredFile implements ICloudStoredFile {
    ...
    static fromJS(data: any): CloudStoredFile {
        data = typeof data === 'object' ? data : {};
        let result = new CloudStoredFile();
        result.init(data);
        return result;
    }
...
export interface ICloudStoredFile {
    id?: string;
    url?: string | undefined;
    createdAt?: string;
    fileType?: FileType;
...
export class Like implements ILike {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.authorId = _data["authorId"];
            this.author = _data["author"] ? ApplicationUser.fromJS(_data["author"]) : undefined as any;
            this.publicationId = _data["publicationId"];
            this.publication = _data["publication"] ? Publication.fromJS(_data["publication"]) : undefined as any;
...
export class Publication implements IPublication {
    ...
    cloudStoredFiles?: CloudStoredFile[] | undefined;
    isHidden?: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.parentId = _data["parentId"];
            this.parent = _data["parent"] ? Publication.fromJS(_data["parent"]) : undefined as any;
            if (Array.isArray(_data["comments"])) {
                this.comments = [] as any;
                for (let item of _data["comments"])
                    this.comments!.push(Publication.fromJS(item));
            }
            if (Array.isArray(_data["cloudStoredFiles"])) {
                this.cloudStoredFiles = [] as any;
                for (let item of _data["cloudStoredFiles"])
                    this.cloudStoredFiles!.push(CloudStoredFile.fromJS(item));
            }
            this.isHidden = _data["isHidden"];
            this.engagementScore = _data["engagementScore"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.cloudStoredFiles)) {
            data["cloudStoredFiles"] = [];
            for (let item of this.cloudStoredFiles)
                data["cloudStoredFiles"].push(item ? item.toJSON() : undefined as any);
        }
...
export class PublicationCreateRequest implements IPublicationCreateRequest {
    description?: string | undefined;

    constructor(data?: IPublicationCreateRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): PublicationCreateRequest {
        data = typeof data === 'object' ? data : {};
        let result = new PublicationCreateRequest();
        result.init(data);
        return result;
    }
